...
# 情感词典
print "reading..."
posdict = tp.read_lines(path+"/positive_negative_dictionary/posdict.txt")
negdict = tp.read_lines(path+"/positive_negative_dictionary/negdict.txt")
# 程度副词词典
mostdict = tp.read_lines(path+"/adverbs_of_degree_dictionary/most.txt")   # 权值为2
verydict = tp.read_lines(path+"/adverbs_of_degree_dictionary/very.txt")   # 权值为1.5
moredict = tp.read_lines(path+"/adverbs_of_degree_dictionary/more.txt")   # 权值为1.25
ishdict = tp.read_lines(path+"/adverbs_of_degree_dictionary/ish.txt")   # 权值为0.5
insufficientdict = tp.read_lines(path+"/adverbs_of_degree_dictionary/insufficiently.txt")  # 权值为0.25
inversedict = tp.read_lines(path+"/adverbs_of_degree_dictionary/inverse.txt")  # 权值为-1
...
def run_score():
    results=[]
#    file=open('sample','r+')
    file=open('server_single_weibo.txt','r+')
